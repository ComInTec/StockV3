...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form method="GET"  class="form-horizontal form-groups-bordered" action="cree-client_confirm.php">
            ...
            <center>
                <table  class="table table-bordered table-striped datatable" id="table-2">
                    <tr class="tr-gauche">
                        ...
                        <td class="td-client">
                            <input autocomplete="off" name = "societe" type = "text" class="input-daterange" value="<?php if(isset($_GET['societe'])) echo($_GET['societe']); ?>" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="td-client">
                            <input autocomplete="off" name = "telephone" class = "input-table" type = "text" value="<?php if(isset($_GET['telephone'])) echo($_GET['telephone']); ?>"/>
                        </td>
                        <td class="td-point">&nbsp;</td>
                    </tr>
...
<br/>
            ...
            <br />
            <input class ="" name = "register" id = "register"   type= "submit"    value = "Enregistrer" />
        </form>
        <br />
        <br />
        <!-- end .content -->
