...
<script src="../bl/media/js/jquery.js" type="text/javascript">
</script>
<script src="../bl/media/js/jquery.dataTables.js" type="text/javascript">
</script>
...
// $somme_qt=0;
// $somme_rev=0;
// $string_query= "SELECT  `facture_achat`.`id_fachat`  ,  `detail_fachat` . `qtt`, `facture_achat`.`date` ,`detail_fachat`.`prix_rev`  FROM `facture_achat`,`detail_fachat` where `detail_fachat`.`id_fachat` = facture_achat.id_fachat and  

// ";
  
  // $string_query= $string_query."
  // `facture_achat`.`date`< '$date1' and
  // `facture_achat`.`date`>= '$date2'";
// $req=mysqli_query($link,$string_query)or die (mysqli_error($link));
